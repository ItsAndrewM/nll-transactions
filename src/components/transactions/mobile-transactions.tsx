			...
			<div className="flex gap-4 items-center justify-between w-full py-4 relative flex-nowrap flex-col">
				...
				<div className="flex justify-center items-center gap-4 w-full">
					<Input
						...
						className="max-w-md rounded-md border border-input bg-background px-3 py-2 text-sm shadow-xs ring-offset-background placeholder:text-muted-foreground focus:outline-hidden focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50"
